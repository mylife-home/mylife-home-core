...
module.exports = class {
  constructor(config) {
    ...
    this._componentManager = new components.Manager(config.net);
  ...
  _componentCreate(data) {
    const pluginInfo = this._pluginManager.localLookup(data.library, data.type);
    this._componentManager.create(pluginInfo, data.comp_id, data.config, data.designer);
  }
      ...
      component: {
        ...
        children: {
          ...
          delete: {
            ...
            impl: (w, m) => {
              try {
                this._componentDelete(m);
                w('Component Delete');
              } catch(ex) {
                w('Delete error: ' + ex.message);
              }
            }
          }
        }
